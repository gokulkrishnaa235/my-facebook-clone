This Project is clone App of Facebook. You can login using your Gmail account to see others posts and to add add your own post along the image Url that you want to upload.
